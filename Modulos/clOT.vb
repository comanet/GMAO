...
Public Class clOT
    ...
    Public daOT As New SqlDataAdapter
    Public da As New SqlDataAdapter
    Public bsOT As New BindingSource
    Private comando As SqlCommand

    Public Sub ConsultaOT(ByVal sql As String)

        cnn.Open()

        daOT = New SqlDataAdapter(sql, cnn)
        daOT.Fill(dsOT, "tbl_PLANESGMAO")
        bsOT.DataSource = dsOT.Tables("tbl_PLANESGMAO")
    ...
    Public Function InsertaOT(ByVal query As String) As Boolean
